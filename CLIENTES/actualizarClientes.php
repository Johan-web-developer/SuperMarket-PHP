...
if (isset($_POST["editar"])){
  ...
  $data-> update();
  echo "<script>alert('Cliente actualizado satisfactoriamente'); document.location='clientes.php'</script>";
}
...
<body>
    <h1 class="m-2">Editar Cliente</h1>
    <div id="contenido">
      <form class="col d-flex flex-wrap" action=""  method="post">
              ...
              <div class="mb-1 col-12">
                ...
                <input 
                  ...
                  name="compañia"
                  class="form-control"  
                  value ="<?php echo $vall['compañia'];?>"
                />
              </div>
                 <div class=" col-12 m-2">
                <input type="submit" class="btn btn-success" value="Guardar Cambios" name="editar"/>
                <button class="btn btn-light"><a href="clientes.php">Volver</a></button>
              </div>
            </form>  
