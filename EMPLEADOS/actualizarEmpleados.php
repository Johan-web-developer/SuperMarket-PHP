...
if (isset($_POST["editar"])){
  ...
  $data-> update();
  echo "<script>alert('Empleado actualizado satisfactoriamente'); document.location='empleados.php'</script>";
}
...
<body>
    <h1 class="m-2">Editar Empleado</h1>
    <div id="contenido">
      <form class="col d-flex flex-wrap" action=""  method="post" enctype="multipart/form-data">
              ...
              <div class="mb-1 col-12">
                ...
                <button class="btn btn-light"><a href="empleados.php">Volver</a></button>
              </div>
            </form>  
