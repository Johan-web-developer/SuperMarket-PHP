...
<body>
  <div class="boxes">
    ...
    <div class="container">
      <div class="boton">
        <button class="btn btn-success botoncito" data-bs-toggle="modal" data-bs-target="#registrarEmpleados"><i class="bi bi-person-add" ></i></button>
      </div>
      <h1>EMPLEADOS</h1>
      <table class="table table-stripped table-success" style="text-align:center;">
                ...
                <tbody class="tabla" id="tabla">
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-danger" href="borrarEmpleado.php?id=<?=$value['id']?>&req=delete">Borrar</a>
                      </td>
                      <td>
                        <a class="btn btn-warning" href="actualizarEmpleados.php?id=<?=$value['id']?>">Editar</a>
                      </td>
                    </tr>
                        <?php }?>
                </tbody>
